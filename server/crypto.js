...
const SENSITIVE_KEYS = ['zhipu_api_key', 'zhipu_api_keys', 'ai_configs', 'ai_vendor_configs', 'ai_dispatch_order', 'imgbb_api_key', 'comfyui_creds', 'oss_access_key_id', 'oss_access_key_secret', 'oss_bucket', 'oss_region', 'oss_endpoint', 'turso_config'];
