function initMeituCollage() {
  if (initMeituCollage._init) return;
  initMeituCollage._init = true;
  ...
  var btnAiGen = document.getElementById('btnAiGen');
  if (btnAiGen) btnAiGen.addEventListener('click', function () {
