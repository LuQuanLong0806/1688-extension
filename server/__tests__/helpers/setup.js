...
// 本地表结构（与 db.js 保持一致）
// sql.js 新版要求 DEFAULT 非常量表达式用单引号 + 括号：datetime('now', '+8 hours')
const LOCAL_TABLE_DEFS = [
  { name: 'products', ddl: `CREATE TABLE IF NOT EXISTS products (id INTEGER PRIMARY KEY AUTOINCREMENT, source_url TEXT NOT NULL, title TEXT, main_images TEXT, desc_images TEXT, attrs TEXT, skus TEXT, status INTEGER DEFAULT 0, created_at DATETIME DEFAULT (datetime('now', '+8 hours')), updated_at DATETIME DEFAULT (datetime('now', '+8 hours')), category TEXT, detail_images TEXT, custom_category TEXT, dxm_category TEXT DEFAULT '', manual_category TEXT, deleted INTEGER DEFAULT 0, uid TEXT, store_name TEXT DEFAULT '', variant_attr_name TEXT DEFAULT '', product_no TEXT DEFAULT '', variant_attr_name2 TEXT DEFAULT '', variant_attr_name3 TEXT DEFAULT '', variant_attr_images TEXT DEFAULT '', original_images TEXT DEFAULT '', automation_stage TEXT DEFAULT 'none', automation_log TEXT DEFAULT '', automation_issues TEXT DEFAULT '', automation_started_at DATETIME, automation_finished_at DATETIME, owner TEXT DEFAULT '', claim_at TEXT DEFAULT '')` },
  ...
  { name: 'users', ddl: `CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT NOT NULL UNIQUE, password_hash TEXT NOT NULL, password_salt TEXT NOT NULL, display_name TEXT DEFAULT '', role TEXT DEFAULT 'operator', last_login TEXT DEFAULT '', must_change_password INTEGER DEFAULT 0, disabled INTEGER DEFAULT 0, created_at TEXT DEFAULT '', updated_at TEXT DEFAULT '')` }
];
