...
// 表结构 DDL
const TABLE_DDLS = [
  `CREATE TABLE IF NOT EXISTS products (id INTEGER PRIMARY KEY AUTOINCREMENT, uid TEXT DEFAULT '', source_url TEXT NOT NULL, title TEXT, main_images TEXT DEFAULT '', desc_images TEXT DEFAULT '', detail_images TEXT DEFAULT '', attrs TEXT DEFAULT '', skus TEXT DEFAULT '', status INTEGER DEFAULT 0, created_at DATETIME DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP, category TEXT DEFAULT '', custom_category TEXT DEFAULT '', dxm_category TEXT DEFAULT '', manual_category TEXT DEFAULT '', deleted INTEGER DEFAULT 0, store_name TEXT DEFAULT '', variant_attr_name TEXT DEFAULT '', product_no TEXT DEFAULT '', variant_attr_name2 TEXT DEFAULT '', variant_attr_name3 TEXT DEFAULT '', variant_attr_images TEXT DEFAULT '', automation_stage TEXT DEFAULT 'none', automation_log TEXT DEFAULT '', automation_issues TEXT DEFAULT '', automation_started_at DATETIME, automation_finished_at DATETIME, original_images TEXT DEFAULT '', owner TEXT DEFAULT '', claim_at TEXT DEFAULT '')`,
  ...
  `CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT NOT NULL UNIQUE, password_hash TEXT NOT NULL, password_salt TEXT NOT NULL, display_name TEXT DEFAULT '', role TEXT DEFAULT 'operator', last_login TEXT DEFAULT '', must_change_password INTEGER DEFAULT 0, disabled INTEGER DEFAULT 0, token_invalid_at TEXT DEFAULT '', created_at TEXT DEFAULT '', updated_at TEXT DEFAULT '')`
];
