...
h += '<button id="btnSmall" class="s4">\uD83D\uDD0D \u663E\u793A\u5C0F\u56FE</button>';
    ...
    h += '<div class="grid" id="grid"></div><div class="preview" id="preview"><div class="close" id="previewClose">\u2715</div><img id="previewImg"></div>';
    h += '<scr' + 'ipt>';
    ...
    h += 'var openLink=document.createElement("button");openLink.className="openbtn";openLink.textContent="\u9884\u89C8";openLink.dataset.u=u;';
