...
.logo{display:inline-flex;align-items:center;gap:8px;margin-right:14px;font-size:22px;font-weight:600;letter-spacing:1px;color:#ff6a00;filter:drop-shadow(1px 2px 4px rgba(76,175,80,.25));animation:logoIn .8s cubic-bezier(.34,1.56,.64,1) both,logoFloat 3s ease-in-out .8s infinite}
.logo svg{width:52px;height:35px;flex-shrink:0}
